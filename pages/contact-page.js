    ...
    <Layout title="Contact">
      <div className="bg-white text-center shadow-xl p-8 w-80 rounded">
        ...
        <div className="mt-6 flex justify-around">
          <div>
            <a
              href="https://nerdcave.com/tailwind-cheat-sheet" //自身のツイッターアカウント
              target="_blank"
          ...
          <div>
            <a
              href="https://nerdcave.com/tailwind-cheat-sheet" //自身のfacebookアカウント
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
          ...
          <div>
            <a
              href="https://nerdcave.com/tailwind-cheat-sheet" //自身のgit-hubアカウント
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
